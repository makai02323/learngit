...
<script>
    export default {
        ...
        methods:{
            ...
            getM(){
                this.type=1;
                this.ajaxC('/assets/selectAssetsLogType',{walletType:3,startTime:'',endTime:'',pageNum:this.currentPage,pageSize:this.currentCount},'get',this.ok)
            },
            ok(res){
                this.tableData=[];
                if(res.data.code==0){
            ...
            sou(){
                this.type=2;
                this.ajaxC('/assets/selectAssetsLogType',{walletType:3,startTime:this.value1,endTime:this.value2,id:this.input,pageNum:this.currentPage1,pageSize:this.currentCount1},'get',this.ok1)
            },
            ok1(res){
                this.tableData=[];
                if(res.data.code==0){
